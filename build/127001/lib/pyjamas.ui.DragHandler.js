...
$pyjs['loaded_modules']['pyjamas.ui.DragHandler'] = function (__mod_name__) {
	...
	try {
		...
		$m['fireDragEvent'] = function(listeners, event) {
			...
			var $iter3_idx,$iter2_nextval,$iter1_nextval,$iter1_type,$iter2_iter,$iter3_array,$iter3_nextval,$iter3_type,$iter2_idx,$iter1_iter,listener,$iter3_iter,$iter1_array,$pyjs__trackstack_size_1,etype,$iter2_type,$iter2_array,$iter1_idx;
